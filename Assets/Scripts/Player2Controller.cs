...
public class Player2Controller : MonoBehaviour
{
    ...
    {
        horizontalInput = Input.GetAxis("HorizontalArrow");// Bind the value of horizontalInput to the Horizontal axis, bound to A and D
        verticalInput = Input.GetAxis("VerticalArrow");// Bind the value of verticalInput to the Vertical axis, bound to W and S
